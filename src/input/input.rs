...
use bevy::{ecs::{entity::Entity, event::EventReader, system::{Commands, Query, ResMut}}, hierarchy::Children, input::keyboard::{Key, KeyboardInput}, text::TextSpan, window::Ime};

use crate::{
    cursur::TextCursor,
    event::TextEdited,
    text_field::{Select, TextField, TextFieldPosition},
    tool::{splite_text, ToolString},
    LastEmoji
};
